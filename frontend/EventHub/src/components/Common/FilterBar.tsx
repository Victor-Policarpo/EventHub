    ...
    return (
        <div className="flex items-center flex-wrap gap-3">
            <div className="relative">
                ...
                {isOpen && (
                    <div className="absolute top-full left-0 mt-2 w-96 bg-white border border-gray-200 rounded-xl shadow-xl z-50 p-4 animate-in fade-in zoom-in-95 duration-150">
                        {children}
